                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        ...
                                        <button class="btn btn-aguamarina btn-default btn-squared ">Agua marina
                                        </button>
                                        <button class="btn btn-limon btn-default btn-squared ">Limon
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        ...
                                        <button
                                            class="btn btn-aguamarina btn-default btn-squared btn-transparent-aguamarina">Agua marina
                                        </button>
                                        <button
                                            class="btn btn-limon btn-default btn-squared btn-transparent-limon">Limon
                                        </button>
                                        <button
                                            class="btn btn-light btn-default btn-squared btn-transparent-light text-gray">Light
                                        </button>
                                    </div>
                                    <!-- ends: .atbd-button-list" -->
                                </div>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        ...
                                        <button class="btn btn-aguamarina btn-default btn-rounded">Agua marina
                                        </button>
                                        <button class="btn btn-limon btn-default btn-rounded">Limon
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        <button class="btn btn-primary btn-default btn-squared "><svg
                                        ...
                                        <button
                                            class="btn btn-primary btn-default btn-squared btn-transparent-primary "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                            ...
                                            Default
                                        </button> <button class="btn btn-default btn-squared btn-outline-primary "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        <button class="btn btn-default btn-squared btn-outline-light "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                            ...
                                            Default
                                        </button> <button class="btn btn-light btn-default btn-squared "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        <button class="btn btn-white btn-default btn-squared btn-shadow-white "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                            ...
                                            Default
                                        </button> <button class="btn btn-icon btn-primary btn-squared">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        </button> <button class="btn btn-icon btn-light btn-squared">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-block">
                                        ...
                                        <div class="button-inline-list my-n2">
                                            ...
                                            <div class="btn-group atbd-button-group btn-group-normal my-2" role="group">
                                                ...
                                                <button type="button"
                                                    class="btn  btn-xs btn-outline-light">Month</button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Year</button>

                                            </div>
                                            <div class="btn-group atbd-button-group btn-group-normal my-2" role="group">
                                                <button type="button"
                                                    class="btn  btn-xs btn-outline-light">Cancel</button>
                                                <button type="button" class="btn  btn-xs btn-outline-light">Ok</button>

                                            </div>
                                            <div class="btn-group atbd-button-group btn-group-solid my-2" role="group">
                                                <button type="button" class="btn  btn-xs btn-outline-light">Left</button>
                                                <button type="button"
                                                    class="btn  btn-xs btn-outline-light">Middle</button>
                                                <button type="button"
                                                    class="btn  btn-xs btn-outline-light">Right</button>
                                    ...
                                    <div class="atbd-button-block m-top-30">
                                        ...
                                        <div class="button-inline-list">
                                            ...
                                            <div class="btn-group atbd-button-group btn-group-withIcon my-2"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap"> <button
                                            class="btn btn-default btn-squared btn-outline-primary ">Primary
                                        </button>
                                        ...
                                        <button class="btn btn-default btn-squared btn-outline-aguamarina ">Agua marina
                                        </button>
                                        <button class="btn btn-default btn-squared btn-outline-limon ">Limon
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        ...
                                        <button class="btn btn-aguamarina btn-default btn-squared btn-shadow-aguamarina ">Dark
                                        </button>
                                        <button class="btn btn-limon btn-default btn-squared btn-shadow-limon ">Limon
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap"> <button
                                            class="btn btn-default btn-rounded btn-outline-primary ">Primary
                                        </button>
                                        ...
                                        <button class="btn btn-default btn-rounded btn-outline-aguamarina ">Agua marina
                                        </button>
                                        <button class="btn btn-default btn-rounded btn-outline-limon">Limon
                                        </button>
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        <button class="btn btn-primary btn-default btn-rounded "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        <button
                                            class="btn btn-primary btn-default btn-rounded btn-transparent-primary "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                            ...
                                            Default
                                        </button> <button class="btn btn-default btn-rounded btn-outline-primary "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        <button class="btn btn-default btn-rounded btn-outline-light "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                            ...
                                            Default
                                        </button> <button class="btn btn-light btn-default btn-rounded "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        <button class="btn btn-white btn-default btn-squared btn-shadow-white "><svg
                                            ...
                                            Default
                                        </button> <button class="btn btn-icon btn-primary btn-circle">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        </button> <button class="btn btn-icon btn-light btn-circle">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- ends: .atbd-button-list" -->
                                    <div class="atbd-button-list d-flex flex-wrap align-items-end"> <button
                                            class="btn btn-default btn-squared btn-outline-light text-gray">Default
                                        </button>
                                        <button class="btn btn-default btn-squared btn-outline-light "
                            ...
                            <div class="card card-default card-md mb-4">
                                ...
                                <div class="card-body gradient1">
                                    <div class="atbd-button-list d-flex flex-wrap">
                                        ...
                                        <button class="btn btn-ghost btn-default btn-squared "><svg
                                                xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-layers">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-description">Add class <code>.btn-{color}</code> for
                                                        buttons
                                                        in theme colors</p>
                                                    <div class="template-demo">
                                                        ...
                                                        <button type="button" class="btn btn-aguamarina">Agua</button>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <div class="template-demo">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-aguamarina btn-rounded btn-fw">Agua</button>
                                                        <button type="button"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-description">Add class <code>.btn-outline-{color}</code>
                                                        for
                                                        outline buttons</p>
                                                    <div class="template-demo">
                                                        <button type="button"
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-outline-aguamarina">Agua</button>
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <div class="template-demo">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-inverse-aguamarina">Agua</button>
                                                        <button type="button" class="btn btn-link btn-fw">Link</button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-7">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-description">Add class <code>.btn-icon</code> for
                                                        buttons
                                                        with only icons</p>
                                                    ...
                                                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-inverse-aguamarina btn-icon">
                                                            <i class="mdi mdi-map-marker"></i>
                                                        </button>
                                                    </div>
                                                    <div
                                            ...
                                            <div class="col-md-5">
                                                <div class="card-body">
                                                    ...
                                                    <div class="template-demo mt-4">
                                                        <button type="button"
                                                            class="btn btn-danger btn-lg">btn-lg</button>
                                                        <button type="button"
                                                            class="btn btn-success btn-md">btn-md</button>
                                                        <button type="button"
                                                            class="btn btn-primary btn-sm">btn-sm</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-description">Wrap a series of buttons with
                                                        <code>.btn</code>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="template-demo">
                                                ...
                                                <button type="button"
                                                    class="btn btn-social-icon btn-outline-youtube"><i
                                                        class="mdi mdi-youtube"></i></button>
                                                <button type="button"
                                                    class="btn btn-social-icon btn-outline-twitter"><i
                                                        class="mdi mdi-twitter"></i></button>
                                                <button type="button"
                                                    class="btn btn-social-icon btn-outline-dribbble"><i
                                                        class="mdi mdi-dribbble"></i></button>
                                                <button type="button"
                                                    class="btn btn-social-icon btn-outline-linkedin"><i
                                            ...
                                            <div class="template-demo">
                                                ...
                                                <button type="button"
                                                    class="btn btn-social-icon btn-twitter btn-rounded"><i
                                                        class="mdi mdi-twitter"></i></button>
                                                <button type="button"
                                                    class="btn btn-social-icon btn-dribbble btn-rounded"><i
                                                        class="mdi mdi-dribbble"></i></button>
                                                <button type="button"
                                                    class="btn btn-social-icon btn-linkedin btn-rounded"><i
                                                        class="mdi mdi-linkedin"></i></button>
                                                <button type="button"
                                                    class="btn btn-social-icon btn-google btn-rounded"><i
                                                        class="mdi mdi-google-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
